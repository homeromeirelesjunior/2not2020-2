...
// Forma 3: splice()
// 1º parâmetro: a posição da inserção
...
// O retorno do splice() na remoção será um vetor contendo o(s) item(ns) removidos
...
// O início da variável é sempre a posição 0 e seu incremento deve ir até uma posição ANTES do seu número de elemntos (length)
// i++ significa i = i + 1
for(let i = 0; i < vetor1.lenght; i++) {
    console.log(vetor1[i])
}

// Forma 2: usando o for..of
